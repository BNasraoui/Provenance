...
pub use model::{
    ...
    validate_unique_ids, ArtifactChangeType, ArtifactLink, ArtifactLinkTargetType, Boundary,
    CanonicalArtifact, CanonicalArtifactType, ClaimChallenge, ConsensusFinding, ContestedClaim,
    Contribution, ContributionStance, Domain, Edge, EdgeType, EvidenceGap, EvidenceQuality,
