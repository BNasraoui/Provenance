...
pub use model::{
    ...
    validate_optional_confidence_score, ArtifactChangeType, ArtifactLink, ArtifactLinkTargetType,
    Boundary, CanonicalArtifact, CanonicalArtifactType, ClaimChallenge, ConsensusFinding,
    ContestedClaim, Contribution, ContributionStance, Domain, Edge, EdgeType, EvidenceGap,
    EvidenceQuality, IdeationEvidenceReference, IdeationEvidenceType, IdeationTarget,
    IdeationTargetType, IdentityType, Manifest, MaterialClaim, Message, MessageRole,
    ...
    RepoPathPrefix, RequiredHumanDecision, Requirement, RequirementStatus, Resolution,
    ResolutionInput, ResolutionInputType, ResolutionMethod, ResolutionStatus, Rule, RuleModality,
    RuleSeverity, RuleStatus, RuleType, SchemaVersion, Scope, ScopeId, Service, ServiceBinding,
