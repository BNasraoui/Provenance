...
pub(in crate::handlers::check) fn validate(
    ...
    for contribution in &records.contributions {
    ...
    for synthesis_packet in &records.synthesis_packets {
        check_ideation_target(
            index,
            dangling,
            scope_id,
    ...
    for proposal in &records.proposal_cards {
    ...
    for promotion_decision in &records.promotion_decisions {
        check_scoped_reference(
            index,
            dangling,
            scope_id,
