...
mod tests {
    ...
    const REMOTE: &str = "git@github.com:visualcare/vc-api.git";
    ...
    fn requirement_fixture() -> RequirementPage {
        ...
        RequirementPage {
            ...
            lineage: vec![
                LineageEntry {
                    link: link(PageKind::Requirement, "req_platform", "Visualcare platform"),
                    is_current: false,
                },
                LineageEntry {
    ...
    fn requirement_page_links_every_code_reference() {
        ...
        assert!(html
            .contains("https://github.com/visualcare/vc-api/blob/HEAD/src/UseCase.php#L153-L156"));
        ...
        assert!(html
            .contains("https://github.com/visualcare/vc-api/blob/HEAD/src/UseCase.php#L211-L233"));
    ...
    fn resolution_page_renders_inputs_as_citations_and_attribution() {
        ...
        assert!(
            html.contains("https://github.com/visualcare/vc-api/blob/HEAD/src/UseCase.php#L59-L69")
        );
