...
mod tests {
    ...
    fn parse_git_remote_reads_https_github_urls() {
        let remote = parse_git_remote("https://github.com/visualcare/vc-api.git").unwrap();
        assert_eq!(remote.host, GitHost::GitHub);
        assert_eq!(remote.owner, "visualcare");
        assert_eq!(remote.repo, "vc-api");
    }

    #[test]
    fn parse_git_remote_accepts_missing_git_suffix_and_trailing_slash() {
        let remote = parse_git_remote("https://github.com/visualcare/vc-api/").unwrap();
        assert_eq!(remote.owner, "visualcare");
        assert_eq!(remote.repo, "vc-api");
    }
    ...
    fn parse_git_remote_reads_scp_style_ssh_urls() {
        let remote = parse_git_remote("git@github.com:visualcare/vc-api.git").unwrap();
        assert_eq!(remote.host, GitHost::GitHub);
        assert_eq!(remote.owner, "visualcare");
        assert_eq!(remote.repo, "vc-api");
    }
    ...
    fn github_remote() -> GitRemote {
        GitRemote {
            host: GitHost::GitHub,
            owner: "visualcare".to_string(),
            repo: "vc-api".to_string(),
        }
    }
    ...
    fn blob_url_anchors_github_single_lines() {
        ...
        assert_eq!(
            ...
            "https://github.com/visualcare/vc-api/blob/abc1234/src/UseCase.php#L153"
        );
    }
    ...
    fn blob_url_omits_the_anchor_without_lines() {
        ...
        assert_eq!(
            blob_url(&github_remote(), "HEAD", &code_ref),
            "https://github.com/visualcare/vc-api/blob/HEAD/docs/save-invoice.md"
        );
    }
    ...
    fn detect_remote_url_reads_the_origin_remote() {
        ...
        run(&[
            ...
            "add",
            "origin",
            "git@github.com:visualcare/vc-api.git",
        ]);
        assert_eq!(
            detect_remote_url(dir.path()).as_deref(),
            Some("git@github.com:visualcare/vc-api.git")
        );
    }
